...
ICON_GLOBAL="https://raw.githubusercontent.com/alertesmeteo-hub/ICON-GLOBAL-13-km/data/"
...
def icon_global():
 ...
 for utc in sorted(grouped):
  inc=mean(grouped[utc]); total+=inc or 0; points.append({"valid_utc":utc,"total_mm":round(total,1)})
 return {"id":"ICON_GLOBAL","label":"ICON Global 13 km","status":"ok","run_utc":idx["model"]["run_time"],"points":points}
def gfs():
